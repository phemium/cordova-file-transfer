...
|AppVeyor|Travis CI|
|:-:|:-:|
|[![Build status](https://ci.appveyor.com/api/projects/status/github/phemium/cordova-file-transfer?branch=master)](https://ci.appveyor.com/project/ApacheSoftwareFoundation/cordova-file-transfer)|[![Build Status](https://travis-ci.org/apache/cordova-file-transfer.svg?branch=master)](https://travis-ci.org/apache/cordova-file-transfer)|
...
```bash
cordova plugin add @phemium-costaisa/cordova-file-transfer
```
