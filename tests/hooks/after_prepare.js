...
module.exports = function (context) {
    ...
    function getFileTransferServerAddress (context) {
        ...
        if (
            ...
            platformJson.installed_plugins['cordova-file-transfer-tests'] &&
            platformJson.installed_plugins['cordova-file-transfer-tests'].FILETRANSFER_SERVER_ADDRESS
        ) {
            return platformJson.installed_plugins['cordova-file-transfer-tests'].FILETRANSFER_SERVER_ADDRESS;
        } else {
            return null;
        }
    }
