...
FileTransfer.prototype.upload = function (filePath, server, successCallback, errorCallback, options) {
    ...
    // (see https://github.com/phemium/cordova-file-transfer/blob/master/doc/index.md#upload)
    if (!checkURL(server)) {
        if (errorCallback) {
...
FileTransfer.prototype.download = function (source, target, successCallback, errorCallback, trustAllHosts, options) {
    ...
    // Check if target URL doesn't contain spaces. If contains, it should be escaped first
    // (see https://github.com/phemium/cordova-file-transfer/blob/master/doc/index.md#download)
    if (!checkURL(source)) {
        if (errorCallback) {
